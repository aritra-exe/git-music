      ...
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ Hey there, Xenon this side. There's nothing to know about me am just a lazyass developer and a so called youtuber as a gamer. That's all... Yes you can contact me though the the Id mentioned in the about section of the bot. Thanks for reading.\n YouTube : ❤️ [Knighters™](${youtubeLink})\n`)
            .setTimestamp();
